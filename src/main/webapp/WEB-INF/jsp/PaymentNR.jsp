...
<%
		...
		String encmsg = (String)session.getAttribute("encmsg");
		//meeseva end
		...
		if(secdp==null)
		secdp="0";
		if(paytype.equals("meeseva"))
			meeseva_data = "meeseva|" + requestid + "|" + totamt + "|"+appname+ "|"+staffcode+ "|"+msg+ "|"+encmsg;
%>
...
function validate()
{
	...
	var meeseva_data = '<%=meeseva_data%>';
	var mobileno = document.getElementById("mobileno").value ;
	document.getElementById("cscsave").disabled=true;
	if(document.getElementById("paytype").value == "meeseva")
	{	
		document.getElementById("meeseva_data").value=meeseva_data;
		document.frm.action="MeesevaPayment";
	}
	else{
...
<input type="hidden" name="paytype" id="paytype" value="<%=(String)session.getAttribute("paytype") %>"/>
<input type="hidden" name="nregno" id="nregno" value="<%=regno %>"/>
<input type="hidden" name="meeseva_data" id="meeseva_data" />
