            ...
            <div class="authfy-login">
              ...
              <div class="authfy-panel panel-login text-center active wow fadeInDown animated" id="loginPanel">
                <div class="authfy-heading">
                  <h3 class="auth-title">Registration for Service Connection of Apartment/Layout</h3>
                  <div class="row p-1 justify-content-center" >
	                                    	<div class="existing-services text-danger pt-2">
			                       				<label class="radio-inline" for="type_apartment">
	      											<input type="radio" name="reg_type" id="type_apartment" value="N" checked>Apartment
	    										</label>
	    										<label class="radio-inline" for="type_layout">
	      											<input type="radio" name="reg_type" id="type_layout" value="Y">Layout
	    										</label>
											    
					                      	</div>
	                                	</div><br>
                  <p>Fill in your Mobile No. for OTP for verification</p>
                </div>
                <div class="row">
                  <div class="col-xs-12 col-sm-12" id="login">
                      ...
                      <div class="form-group">
                   	  ...
                   	  <div class="form-group">
                       	<button class="btn btn-lg btn-success btn-block lnk-toggler" type="button" id="preqPanel" data-panel=".panel-verify">Check Prerequisites</button>
                      </div>
                      <!--  <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-12">
                    ...
                    <div class="form-group p-2">
                         <div class="form-group row p-1">
                             <div class="col-sm-8 text-left">Application Fee per Connection(Domestic)</div>
                             <div class="col-sm-4 text-right" id="af_pre">25</div>
                         </div>
                         <div class="form-group row p-1">
                             <div class="col-sm-8 text-left">GST on Application Fee(Domestic)</div>
                             <div class="col-sm-4 text-right" id="afgst_pre">4.5</div>
                         </div>
                         <div class="form-group row p-1">
                             <div class="col-sm-8 text-left">Application Fee per Connection(Commercial)</div>
                             <div class="col-sm-4 text-right" id="sd_pre">50</div>
                         </div>
                         <div class="form-group row p-1">
                             <div class="col-sm-8 text-left">GST on Application Fee(Commercial)</div>
                             <div class="col-sm-4 text-right" id="afgst_pre">9</div>
                         </div>
                         <div class="form-group row p-1">
                   			<div class="col-sm-12 text-left fs-6">1.ID Proof Copy (JPG/JPEG) Max.Size 100KB<br>
                          		2.Registered Documents of Premises Copy (PDF) Max.Size 5MB<br>
                          		3.GHMC/Grampanchayath Approval Plan (or) Layout Plan (PDF) Max.Size 5 MB
                          	</div>
                         </div>
                         <div class="form-group">
	                        <a class="btn btn-lg btn-primary btn-block lnk-toggler" onclick="proceedReg()" data-panel=".panel-login" href="#">Proceed to Registration</a>
