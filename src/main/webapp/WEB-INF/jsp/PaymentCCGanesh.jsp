...
<%
		...
		String service_charges=(String)session.getAttribute("service_charges");
...
<tr>
	...
	<div align="center">
		<table width="99%" border="1" cellspacing='0' cellpadding='5' class='input-table'>		
			...
			<tr>
				<td align="left" nowrap>Service Type</td>
				<td align="left">&nbsp;Temporary Supply ( Navaratri Pandals )</td>
			</tr>
			<tr>
				<td align="left" nowrap>Required Load</td>
				<td align="left">&nbsp;<%=reqld%>&nbsp;<%=metric%></td>
			</tr>
			<tr>
				<td align="left" nowrap>Service Charges</td>
				<td align="left">&nbsp;Rs.&nbsp;<%=service_charges%></td>
			</tr>
