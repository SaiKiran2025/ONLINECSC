          ...
          <div class="col-sm-6 authfy-panel-left">
            <div class="brand-col">
              <div class="headline">
                ...
                <p>Visit Us : <a href="https://www.tssouthernpower.com">www.tssouthernpower.com</a></p>
                <div class="row social-buttons">
                <ul class="social-network social-circle">
                  <li><a href="https://www.facebook.com/tspdcl" target="_blank" class="icoFacebook" title="Facebook"><i class="fa fa-facebook-f"></i></a></li>
                  <li><a href="https://twitter.com/tsspdclcorporat" target="_blank" class="icoTwitter" title="Twitter"><i class="fa fa-twitter"></i></a></li>
                </ul>
                </div>   
              </div>
            </div>
            ...
            <div class="authfy-login">
              ...
              <div class="authfy-panel panel-login text-center active wow fadeInDown animated" id="loginPanel">
                <div class="authfy-heading">
                  <h3 class="auth-title">Registration of Complaints/Services</h3>                 
                </div>
                <div class="row">
