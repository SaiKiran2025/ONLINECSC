...
<%
		...
		String dom_nos = "", dom_load= "", com_nos = "", com_load= "", tot_nos= "",type="";
		if(regno.startsWith("LTM")){
			dom_nos=(String)session.getAttribute("dom_nos");
			dom_load=(String)session.getAttribute("dom_load");
			com_nos=(String)session.getAttribute("com_nos");
			com_load=(String)session.getAttribute("com_load");
			tot_nos=(String)session.getAttribute("tot_nos");
			type=(String)session.getAttribute("type");
		}
		String reqld="", totld="", appfee_gst="", devchg_gst="";
		if(regno.startsWith("AL")){
			reqld=(String)session.getAttribute("reqld");
			totld=(String)session.getAttribute("totld");
			appfee_gst=(String)session.getAttribute("appfee_gst");
			devchg_gst=(String)session.getAttribute("devchg_gst");
		}
...
<%if(regno.startsWith("LTM")){%>
	<%if(type.equals("N")){%>
		<div class="navbar"> <h3>LT - Apartment Service Connection Registration</h3> </div>
	<%}else{%>
		<div class="navbar"> <h3>LT - Layout Service Connection Registration</h3> </div>
	<%}%>
<%}%>
<%if(regno.startsWith("AL")){%>  
<div class="navbar"> <h3>LT-Additional Load/Enhancement of Load Registration</h3> </div>
<%}%>
...
<tr>
	...
	<div align="center">
		...
		<%if(regno.startsWith("LTM")){%>
			...
			<tr>
				<td align="left" nowrap>No.of Domestic Connections</td>
				<td align="left">&nbsp;<%=dom_nos%></td>
			</tr>
			<tr>
				<td align="left" nowrap>Total Domestic Load</td>
				<td align="left">&nbsp;<%=dom_load%>&nbsp;<%=metric%></td>
			</tr>
			<tr>
				<td align="left" nowrap>No.of Commercial Connections</td>
				<td align="left">&nbsp;<%=com_nos%></td>
			</tr>
			<tr>
				<td align="left" nowrap>Total Commercial Load</td>
				<td align="left">&nbsp;<%=com_load%>&nbsp;<%=metric%></td>
			</tr>
			<tr>
				<td align="left" nowrap>Total No.of Connections</td>
				<td align="left">&nbsp;<%=tot_nos%></td>
			</tr>
			<tr>
		...
		<%if(regno.startsWith("AL")){%>
			...
			<tr>
				<td align="left" nowrap>Additional Load Required</td>
