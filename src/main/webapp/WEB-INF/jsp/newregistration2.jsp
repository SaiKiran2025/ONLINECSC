                            	 	...
                            	 	<div class="row d-flex justify-content-center p-1">
                                		<div class="form-group input-group col-sm-3"  id="d-adjscno">
                                        	<label class="has-float-label">
                                           		<input class="form-control" type="text" id="adj_uscno" name="adj_uscno" placeholder=" "  maxlength="9" onblur="checkUSCNO(1);"/>
                                        ...
                                        <div class="form-group input-group col-sm-3" id="d-secname">
                            ...
                            <div class="col-sm-6">
                            	<div class="panel-heading">
        							...
        							<div class="custom-control custom-switch pull-right">
							        	...
							        	<label class="custom-control-label heading" for="same_addr">Copy Connection Address</label>
							    	</div>
        						</div>	
                                    <div class="rounded-box">
                                        <div class="form-group row p-3">
                            	...
                            	<div class="col-sm-6">
	                                ...
	                                <div class="rounded-box">
	                                    <div class="form-group row p-3">
	                                        ...
	                                        <div class="form-group input-group col-sm-6">
	                                            <label class="has-float-label">
	                                                <input class="form-control" type="text" id="conn_load" name="conn_load" placeholder=" " onblur="getReqPayment(1)"/>
                                    		...
                                    		<div class="form-group row p-3">
		                                        ...
		                                        <div class="form-group input-group col-sm-12">
		                                            <label class="has-float-label">  
		                                                ...
		                                                <span id="doctype">Registered Document (PDF)
		                                                	<span style="color:red">Min.Size 1MB to Max.Size 5MB</span>
		                                                </span>
		                                            </label>
		                                        </div>
		                                        <div class="form-group input-group col-sm-12">
   	...
   	$("#noscnos").blur(function(){
		...
		if($("#noscnos").val()!=""){
			if($("#noscnos").val()<5){
				...
				addscnos+="<i class='fa fa-exclamation-triangle fa-lg' aria-hidden='true'></i><strong>Warning!&nbsp;</strong> There are more than 4 Existing Services. Please Register in Low Tention Multi Service (LTM)";
				addscnos+="</div></div></div></div>";	
				$("#addscnos").html(addscnos);
				//$("#form-container").hide();
				srflg="";
